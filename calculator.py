...
btnClear = Button(calc, text=chr(67), width=6, height=2, font=('arial', 16, 'bold'), bd=4, bg="light gray",
                  command=added_value.clear_Entry).grid(row=1, column=1, pady=1)

btnClearAll = Button(calc, text=chr(67) + chr(69), width=6, height=2, font=('arial', 16, 'bold'), bd=4, bg="light gray",
                     command=added_value.all_CLear_Entry).grid(row=1, column=2, pady=1)

btnPM = Button(calc, text=chr(177), width=6, height=2, font=('arial', 16, 'bold'), bd=4, bg="light gray",
               command=added_value.mathsPM).grid(row=1, column=3, pady=1)

# ================================================================================================================

btnSq = Button(calc, text="√", width=6, height=2, font=('arial', 16, 'bold'), bd=4, bg="light gray",
               command=added_value.squared).grid(row=2, column=0, pady=1)

btnCos = Button(calc, text="cos", width=6, height=2, font=('arial', 16, 'bold'), bd=4, bg="light gray",
                command=added_value.cos).grid(row=2, column=1, pady=1)

btnTan = Button(calc, text="tan", width=6, height=2, font=('arial', 16, 'bold'), bd=4, bg="light gray",
                command=added_value.tan).grid(row=2, column=2, pady=1)

btnSin = Button(calc, text="sin", width=6, height=2, font=('arial', 16, 'bold'), bd=4, bg="light gray",
                command=added_value.sin).grid(row=2, column=3, pady=1)

# ================================================================================================================

btnAdd = Button(calc, text="+", width=6, height=2, font=('arial', 16, 'bold'), bd=4, bg="light gray",
                command=lambda: added_value.operation("add")).grid(row=3, column=3, pady=1)

btnSub = Button(calc, text="-", width=6, height=2, font=('arial', 16, 'bold'), bd=4, bg="light gray",
                command=lambda: added_value.operation("sub")).grid(row=4, column=3, pady=1)

btnMult = Button(calc, text="*", width=6, height=2, font=('arial', 16, 'bold'), bd=4, bg="light gray",
                 command=lambda: added_value.operation("multi")).grid(row=5, column=3, pady=1)

btnDiv = Button(calc, text="/", width=6, height=2, font=('arial', 16, 'bold'), bd=4, bg="light gray",
                command=lambda: added_value.operation("divide")).grid(row=6, column=3, pady=1)

# ================================================================================================================

btnZero = Button(calc, text="0", width=6, height=2, font=('arial', 16, 'bold'), bd=4, bg="white",
                 command=lambda: added_value.numberEnter("0")).grid(row=6, column=0, pady=1)

btnDot = Button(calc, text=".", width=6, height=2, font=('arial', 16, 'bold'), bd=4, bg="white",
                command=lambda: added_value.numberEnter(".")).grid(row=6, column=1, pady=1)

btnEquals = Button(calc, text="=", width=6, height=2, font=('arial', 16, 'bold'), bd=4, bg="white",
